      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[340px] sm:w-[420px] md:w-[480px] h-[65vh] z-10 will-change-transform flex items-end justify-center pointer-events-none select-none overflow-hidden"
          >
            <img
